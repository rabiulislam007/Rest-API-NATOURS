...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 2) Check if user exists && passward is correct
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // 4) Check if user changed password aftet the token was issued
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2) If token has nto expired, and there is user, set the new password
  if (!user) {
